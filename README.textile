...
See the "demo map":http://jaredhobbs.github.com/OverlappingMarkerSpiderfier-Leaflet/demo.html (the data is random: reload the map to reposition the markers).

h2. Download

Download "the compiled, minified JS source":http://jaredhobbs.github.com/OverlappingMarkerSpiderfier-Leaflet/bin/oms.min.js.

h2. How to use

See the "demo map source":/jaredhobbs/OverlappingMarkerSpiderfier-Leaflet/blob/gh-pages/demo.html, or follow along here for a slightly simpler usage with commentary.
