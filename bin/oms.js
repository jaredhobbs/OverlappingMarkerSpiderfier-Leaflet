  ...
  this['OverlappingMarkerSpiderfier'] = (function() {
    ...
    p['spiderListener'] = function(marker) {
      ...
      if (markerSpiderfied) {
        ...
        markerPt = this.llToPt(marker.getLatLng());
        _ref = this.markers;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          m = _ref[_i];
          mPt = this.llToPt(m.getLatLng());
    ...
    p['willSpiderfy'] = function(marker) {
      var m, mPt, markerPt, nDist, pxSq, _i, _len, _ref, _ref1, _ref2;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        mPt = this.llToPt((_ref1 = (_ref2 = m['_omsData']) != null ? _ref2.usualPosition : void 0) != null ? _ref1 : m.getLatLng());
        if (this.ptDistanceSq(mPt, markerPt) < pxSq) {
          return true;
        }
      }
    ...
    p['markersThatWillAndWontSpiderfy'] = function() {
      var i, i1, i2, m, m1, m1Data, m2, m2Data, mData, nDist, pxSq, will, wont, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
      ...
      mData = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          m = _ref[_i];
          _results.push({
            pt: this.llToPt((_ref1 = (_ref2 = m['_omsData']) != null ? _ref2.usualPosition : void 0) != null ? _ref1 : m.getLatLng()),
            willSpiderfy: false
          });
        }
        return _results;
    ...
    p['ptToLl'] = function(pt) {
      return this.map.layerPointToLatLng(pt);
    };
